  ...
  en: {
    ...
    contact: {
      ...
      wizard: {
        ...
        q1: "First, who am I talking to?",
        account: { company: "A company", individual: "An individual" },
        q2: "What brings you here?",
        intents: {
          company: [
            { id: "project", label: "A project to build" },
            { id: "collaboration", label: "A collaboration" },
            { id: "hiring", label: "Hiring / a role" },
            { id: "other", label: "Something else" },
          ],
          individual: [
            { id: "question", label: "A quick question" },
            { id: "collaboration", label: "Collaborate on something" },
            { id: "advice", label: "Advice or mentorship" },
            { id: "other", label: "Something else" },
          ],
        },
        q3: "Tell me the idea",
        q3hint: "A few sentences — what it is, and what you're hoping for.",
        messagePlaceholder: "I'm working on…",
        q4: "How do I reach you?",
  ...
  es: {
    ...
    contact: {
      ...
      wizard: {
        ...
        q1: "Primero, ¿con quién hablo?",
        account: { company: "Una empresa", individual: "Un particular" },
        q2: "¿Qué te trae por aquí?",
        intents: {
          company: [
            { id: "project", label: "Un proyecto para construir" },
            { id: "collaboration", label: "Una colaboración" },
            { id: "hiring", label: "Contratar / una vacante" },
            { id: "other", label: "Otra cosa" },
          ],
          individual: [
            { id: "question", label: "Una pregunta rápida" },
            { id: "collaboration", label: "Colaborar en algo" },
            { id: "advice", label: "Consejo o mentoría" },
            { id: "other", label: "Otra cosa" },
          ],
        },
        q3: "Cuéntame la idea",
        q3hint: "Un par de frases — qué es y qué esperas.",
        messagePlaceholder: "Estoy trabajando en…",
        q4: "¿Cómo te contacto?",
