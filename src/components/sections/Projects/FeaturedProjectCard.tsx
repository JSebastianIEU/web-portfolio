...
export default function FeaturedProjectCard({
  ...
  return (
    <div
      className="group relative flex flex-col gap-4 rounded-2xl p-5 md:p-6 transition-all duration-200 h-full"
      style={{
    ...
    >
      ...
      <button
        ...
        aria-label={`View details for ${lang === "es" ? project.titleES || project.title : project.title}`}
      >
        {org && (
          <span
        ...
        {project.logo ? (
          <span
            ...
            style={{
              padding: isDark ? "6px 10px" : "2px 0",
              background: isDark ? "rgba(248,250,252,0.92)" : "transparent",
